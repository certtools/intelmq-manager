  ...
  _loadManipulationSystem: function () {
    ...
    if (this.constants.dataManipulation.enabled == true) {
      ...
      if (this.saveDiv === undefined) {
        ...
        this.saveDiv.className = 'graph-manipulation-saveDiv';
        this.saveDiv.id = 'graph-manipulation-saveDiv';
        this.saveDiv.style.display = 'block';
        this.containerElement.insertBefore(this.saveDiv, this.frame);
        this.saveDiv.innerHTML = "" +
          "<div class='graph-manipulationUI save-state' id='graph-manipulate-saveState'>" +
            "<span class='graph-manipulationLabel' id='graph-manipulationLabel-save'>"+this.constants.labels['saveState'] +"</span></div>";
            
        $("#graph-manipulation-saveDiv").children().on('click', function (event) {
           save_data_on_files(); 
        });
      }
